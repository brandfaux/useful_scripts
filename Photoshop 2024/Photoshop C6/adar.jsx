...
function copyLayersToNewPSD() {
    ...
    if (app.documents.length > 0) {
        ...
        var transformData = {
            "Layer 2": { width: 20, height: 30, x: 2.66, y: 1.67 },
            "Layer 3": { width: 100, height: 100, x: 4.41, y: 1.67 },
            "Layer 4": { width: 100, height: 100, x: 4.41, y: 1.67 },
        ...
        if (!newFile.exists) {
            alert("The file 'adr_mockup2.psd' doesn't exist at the specified path.");
            return;
        }
        ...
        for (var i = 2; i <= 8; i++) {
            try {
                ...
                if (data) {
                    ...
                    pastedLayer.translate(data.x - pastedLayer.bounds[0].value, data.y - pastedLayer.bounds[1].value);
                }
